...
<div class="form-group">
  ...
  <select name="blood"  class="form-control"  type="text" required><option>A+</option><option>B+</option><option>O+</option><option>AB+</option><option>A-</option><option>B-</option><option>O-</option><option>AB-</option></select>
    </div>
  </div>
</div>
...
$sql = "INSERT INTO receiver (Name,Email,Password,Address,Contact,Blood)
VALUES ('$name', '$email', '$pass','$address','$contact','$blood')";
